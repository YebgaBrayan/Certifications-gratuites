...
| --- | --- | --- | --- | --- |
| Certification Gitlab | Gitlab | Parcours et badges de certification gratuits | [Lien](https://about.gitlab.com/learn/) | Inconnu |
| OCI | Oracle | Oracle Cloud Infrastructure, Oracle Cloud Infrastructure, Oracle Cloud Infrastructure | [Lien](https://education.oracle.com/oracle-oci-certification#oracle-cloud-infrastructure) | 30 septembre 2023 |
| Machine Learning avec Python | freeCodeCamp | Cours et certification gratuits | [Lien](https://www.freecodecamp.org/learn/machine-learning-with-python/) | Illimité |
| Visualisation des données | freeCodeCamp | Cours et certification gratuits | [Lien](https://www.freecodecamp.org/learn/data-visualization/) | Illimité |
| Principes fondamentaux de l'IA | Databricks | Principes fondamentaux de l'IA générative | [Lien](https://www.databricks.com/resources/learn/training/generative-ai-fundamentals) | Illimité |
| OCI | Oracle | Oracle Cloud Infrastructure 2023 Foundations Associate | [Lien](https://education.oracle.com/oracle-cloud-infrastructure-2023-foundations-associate/pexam_1Z0-1085-23) |Illimité |
| OCI | Oracle | Oracle Cloud Data Management 2023 Foundations Associate | [Lien](https://education.oracle.com/oracle-cloud-data-management-2023-foundations-associate/pexam_1Z0-1105-23) |Illimité |
| Azure | Pluralsight | Abonnement gratuit à Pluralsight pour les cours Microsoft Azure | [Lien](https://www.pluralsight.com/partners/microsoft/azure) | 01-janv.-2025 |
| Cloud Networking | Aviatrix | Aviatrix, cours et certificat gratuit ACE - Multicloud Networking associate code ACEMULTICLOUD | [Lien](https://aviatrix.teachable.com) | Durée limitée |
| Microsoft | Build : Azure Developer Challenge | Apprenez à concevoir, créer, tester et maintenir des applications et des services cloud sur Microsoft Azure.| [Lien]( https://docs.microsoft.com/en-us/learn/challenges?id=b1ac64ec-f0d3-45fa-beee-f230f9a75e81 ) | 21 juin 2022 |
| JumpCloud | JumpCloud | Certification JumpCloud Core gratuite (d'une valeur de 150 $). | [Lien](https://jumpcloud.com/university/certifications/core) | Durée limitée |
| Google Cloud | QwikLabs | 30 jours supplémentaires pour les laboratoires Google Cloud sur Qwiklabs. | [Lien](https://go.qwiklabs.com/qwiklabs-free) | Inconnu |
| Tests automatisés | Université d'automatisation des tests | Cours de certification gratuits par la Test Automation University. | [Lien](https://testautomationu.applitools.com/) | Inconnu |
| Sécurité | Juniper Networks | Cours et certifications gratuits par Juniper Networks (au lieu de 150 euros). | [Lien](https://learningportal.juniper.net/juniper/user_activity_info.aspx?id=11478) | Inconnu |
| Google Cloud | Qwiklabs | Bénéficiez de 30 jours de Qwiklabs gratuits et d'un accès aux laboratoires en vedette. | [Lien](https://go.qwiklabs.com/googlecloudsolutions) | Inconnu |
| Réseau Huawei | Académie Huawei | Cours et examens gratuits de l'Académie Huawei pour les certifications HCIA, HCIP et HCIE. | [Lien](https://ilearningx.huawei.com/portal/courses) | Inconnu |
| Huawei Networking | Huawei Academ | Cours et certification gratuits (niveau HCIA, valeur de 200 $). | [Lien](https://e.huawei.com/en/talent/#/ict/partner-details?consultationId=545&consClassCode=AUTH&consTypeCode=consulationRZZX&urlForm=certifi) | Inconnu |
| Programmation | JetBrains | Cours gratuits de JetBrains Academy pour apprendre Java, Kotlin et Python. | [Lien](https://www.jetbrains.com/academy/) | Inconnu |
| Cloud Monitoring | Elastic | Accès gratuit à 11 cours Elastic Stack (d'une valeur de 200 $ chacun). | [Lien](https://www.elastic.co/training/free) | Inconnu |
| Divers | Udacity | Un mois gratuit d'accès aux programmes de nanodiplômes d'Udacity (d'une valeur de 400 $). Carte de crédit / PayPal requise. N'oubliez pas d'annuler à temps. | [Lien](https://blog.udacity.com/2020/03/un-mois-gratuit-sur-les-nanodegres.html) | Inconnu |
| Alibaba Cloud | Coursera | « Spécialisation Architecture sur Alibaba Cloud » sur Coursera. | [Lien](https://www.coursera.org/specializations/alibabacloud) | Inconnu |
| DevOps | The Linux Foundation | The Linux Foundation propose 23 cours gratuits avec examens de finalisation et confirmations. | [Lien](https://training.linuxfoundation.org/resources/?_sft_content_type=free-course) | Inconnu |
| DevOps | Université CloudBees | Formation gratuite via l'Université CloudBees (Jenkins, DevOps). | [Lien](https://standard.cbu.cloudbees.com/) | Inconnu |
| Analyse de données | Sumo Logic | 6 formations et certifications gratuites par Sumo Logic. | [Lien](https://www.sumologic.com/learn/certifications/) | Illimité |
| Développement Web | Freecodecamp | 6 cours d'apprentissage et certifications Code Camp gratuits, incl. RWD, JavaScript, API, React… | [Lien](https://www.freecodecamp.org/) | Illimité |
| Divers | Udemy | ~670 cours gratuits sur Udemy, y compris des certificats. | [Lien](https://www.udemy.com/courses/free/) | Illimité |
| cPanel | Université Cpanel | Certification professionnelle cPanel (CPP) gratuite attribuée simplement en réussissant avec succès la série complète de leçons vidéo. Aucun examen de certification final n'est requis pour le statut CPP. | [Lien](https://exams.cpanel.net/catalog/info/id:228,cat:38) | Illimité |
| Plesk | Université Plesk | Certification professionnelle Plesk Obsidian gratuite | [Lien](https://university.plesk.com/catalog/info/id:343) | Illimité |
| SolusIO | Université Plesk | Certification professionnelle SolusIO gratuite | [Lien](https://university.plesk.com/catalog/info/id:369) | Illimité |
| Analytics | Google Analytics Academy | Cours gratuits avec certificats de Google Analytics Academy | [Lien](https://analytics.google.com/analytics/academy/) | Illimité |
...
| Cil | Isovalent | Premiers pas avec Cil | [Lien](https://isovalent.com/labs/getting-started-with-cilium/) | Inconnu |
...
| Intégration | Boomi | Certification de développeur de flux professionnel | [Lien](https://community.boomi.com/s/learning-plan-detail-standard?ltui__urlRecordId=aOM6S0000008OIUWA2<ui__urlRedirect=learning-plan-detail-standard) | Inconnu |
...
| IA | HuggingFace | Cours en ligne gratuit et certification pour l'apprentissage par renforcement profond | [Lien](https://huggingface.co/learn/deep-rl-course) | Illimité |

<p aligner="centre"><un href="#table des matières">(retour en haut)</un></p>

## Sécurité

| Fournisseur | Description | Lien | Expiration |
| --- | --- | --- | --- |
| Certificat Cisco en piratage éthique | Hacker éthique | [Lien](https://www.netacad.com/courses/ethical-hacker?courseLang=en-US) | Illimité |
| Cisco U | Comprendre les principes fondamentaux des opérations de cybersécurité Cisco - CBROPS - 30 crédits de formation continue gratuits | [Lien](https://u.cisco.com/path/32) | 16-nov-2023 |
| ISC² | Bon d'achat 100%, Certifié en cybersécurité℠(CC) Bon d'examen : CC1M12312024 | [Lien](https://www.isc2.org/landing/1mcc) | 31-déc.-2024 |
| Palo Alto Networks | Code promo d'examen de certification gratuit à la fin de la formation de préparation à la certification pendant l'événement. | [Lien](https://ignite.paloaltonetworks.com/) | 18-nov.-2020 |
| Fortinet | Cours de formation et certifications gratuits sur la sécurité des réseaux par Fortinet / NSE Institute. | [Lien](https://www.fortinet.com/corporate/about-us/newsroom/press-releases/2020/fortinet-rend-tous-les-cours-de-formation-en-ligne-sur-la-cybersécurité-disponibles-gratuitement.html) | Illimité |
| Le Conseil Académique d'uLektz | Formation et certification gratuites en cybersécurité. | [Lien](https://www.ulektzskills.com/skills/The-Academic-Council-Of-uLektz/Cyber-Security-NTA4Mg==) | Inconnu |
| APMG International | Certification gratuite de pilote de spécialisation Certified Cyber Professional (CCP) pour**personnes éligibles**(voir le lien pour info). | [Lien](https://apmg-international.com/article/certified-cyber-professional-ccp-specialism-pilot) | Inconnu |
| Cisco Networking Academy | Cours gratuit d'introduction à la cybersécurité avec badge Networking Academy pour avoir terminé ce cours. | [Lien](https://www.netacad.com/courses/cybersecurity/introduction-cybersecurity) | Illimité |
| SkillFront | Formation gratuite ISO/IEC 27001 Information Security Associate™ | [Lien](https://www.skillfront.com/ISO-IEC-27001-Information-Security-Associate) | Illimité |
| AttackIQ | Fondements du Purple Teaming | [Lien](https://www.academy.attackiq.com/courses/foundations-of-purple-teaming) | Illimité |
| AttackIQ | Fondements de la simulation d'attaques et de violations | [Lien](https://www.academy.attackiq.com/courses/foundations-of-breach-attack-simulation) | Illimité |
| AttackIQ | Fondements de l'opérationnalisation de MITRE ATT&CK v13 | [Lien](https://www.academy.attackiq.com/courses/foundations-of-operationalizing-mitre-attck-v13) | Illimité |
| Cisco Networking Academy | Introduction à la cybersécurité | [Lien](https://www.netacad.com/courses/cybersecurity/introduction-cybersecurity) | Illimité |
| Cisco Networking Academy | Notions de base sur la cybersécurité | [Lien](https://www.netacad.com/courses/cybersecurity/cybersecurity-essentials) | Illimité |
| Google Cloud Skills Boost | Principes fondamentaux de la sécurité et de l'identité | [Lien](https://www.cloudskillsboost.google/course_templates/770) | Illimité |
| Open Source Security Foundation | Développement de logiciels sécurisés (LFD121) | [Lien](https://training.linuxfoundation.org/training/developing-secure-software-lfd121/) | Illimité |
| Formation IBM | IBM QRadar SIEM Foundation | [Lien](https://www.ibm.com/training/learning-path/ibm-qradar-siem-foundation-694) | Illimité |
...
| Fournisseur | Description | Lien | Expiration |
| --- | --- | --- | --- |
| Exasol | Formations et certifications Exasol gratuites (d'une valeur de 150 € chacune). | [Lien](https://www.exasol.com/portal/display/TRAINING/Exasol+Training+and+Certification) | 30-juin-2020 |
| Mongodb | 12 cours MongoDB gratuits avec preuve d'achèvement. | [Lien](https://university.mongodb.com/courses/catalog) | Illimité |
| CockcroachLab University | Cert gratuit - les concepts de base des bases de données distribuées et vous donne tous les outils dont vous avez besoin pour démarrer avec CockroachDB | [Lien](https://university.cockroachlabs.com/course/getting-started-with-cockroachdb) | Inconnu |
| CockcroachLab University | Cert gratuit - vous créerez une application de covoiturage full-stack en Python en utilisant le populaire ORM SQLAlchemy et CockroachDB | [Lien](https://university.cockroachlabs.com/course/cockroachdb-for-python-developers) | Inconnu |
| Liquibase | Apprenez tout sur les principes fondamentaux de Liquibase grâce à des cours en ligne gratuits dispensés par des experts Liquibase et découvrez comment les appliquer dans le monde réel. | [Lien](https://learn.liquibase.com/index) | Inconnu |
| Redis | Redis Certified Developer est notre programme de certification professionnelle pour les développeurs de logiciels qui travaillent régulièrement avec Redis. | [Lien](https://university.redis.com/certification/) | Inconnu |
| Databricks | Formation gratuite : Principes fondamentaux de Databricks Lakehouse. | [Lien](https://www.databricks.com/learn/training/lakehouse-fundamentals) | Inconnu |
| SQL | Cours SQL gratuit avec certificat | [Lien](https://www.simplilearn.com/free-online-course-to-learn-sql-basics-skillup) | 90 jours d'accès |
| Neo4j Graph Academy | Certificats d'examen gratuits et certificats de cours attestant de l'achèvement | [Lien](https://graphacademy.neo4j.com) | Inconnu |
| ArangoDB | Professionnel certifié ArangoDB | [Lien](https://www.arangodb.com/learn/certification/) | Illimité |
| CrateDB | CrateDB Academy propose des cours en ligne gratuits et une certification pour notre base de données multi-modèle open source. | [Lien](https://learn.cratedb.com) | Illimité |
...
| Fournisseur | Description | Lien | Expiration |
| --- | --- | --- | --- |
| Certiprof | Certification gratuite « Scrum Foundations Professional Certificate (SFPC) ». Disponible en anglais, pt-br et espagnol. Utilisez le code « COVID19Support » | [Lien](https://certiprof.com/pages/scrum-foundations-professional-certificate-sfpc-english) | Inconnu |
| Six Sigma en ligne | Formation et certification gratuites de ceinture blanche Six Sigma. | [Lien](https://www.sixsigmaonline.org/six-sigma-white-belt-certification/) | Inconnu |
| OHSC | Cours et certificat gratuits de gestion de projet par Oxford Home Study Centre (OHSC). | [Lien](https://www.oxfordhomestudy.com/courses/project-management-courses-online/free-online-courses-with-certificates-in-project-management) | Illimité |
| Msicertified | Formation et certification gratuites Project Management Essentials Certified (PMEC). | [Lien](https://www.msicertified.com/free-project-management-certification.html) | Illimité |
| 6sigmastudy | Cours et certification Six Sigma Yellow Belt gratuits. | [Lien](http://www.6sigmastudy.com/Six-Sigma-Yellow-Belt.asp) | Illimité |
| ScrumStudy | Formation et certification gratuites « Scrum Fundamentals Certified (SFC™) » | [Lien](https://www.scrumstudy.com/certification/scrum-fundamentals-certified) | Illimité |
| SkillFront | Certification gratuite d'associé en Scrum Fundamentals™ (CASF™) | [Lien](https://www.skillfront.com/CASF-Certified-Associate-In-Scrum-Fundamentals) | Illimité |
| Great Learning | Cours de gestion de projet gratuit | [Lien](https://www.mygreatlearning.com/academy/learn-for-free/courses/project-management) | Illimité |
...
| Fournisseur | Description | Lien | Expiration |
| --- | --- | --- | --- |
| Google | Cours gratuit et certificat sur les principes fondamentaux du marketing numérique par Google. | [Lien](https://learndigital.withgoogle.com/digitalgarage/course/digital-marketing) | Illimité |
| Microsoft | Certification et formation Microsoft Advertising. | [Lien](https://about.ads.microsoft.com/en-us/resources/training/get-certified) | Illimité |
| SMstudy | 4 certifications fondamentales liées au marketing gratuites par SMstudy. | [Lien](https://www.smstudy.com/freeresources/earn-4-free-certifications) | Illimité |
| DMAC | Cours et certification gratuits en marketing Facebook et Instagram par DMAC (Digital Marketing Academy of Canada). | [Lien](https://www.yourdmac.com/free-online-social-media-marketing-course) | Durée limitée |
| Hootsuite |**[Réservé aux étudiants]**Certification gratuite de la plateforme Hootsuite (d'une valeur de 99 $) et certification en marketing social (d'une valeur de 199 $) via le programme étudiant de Hootsuite. | [Lien](https://hootsuite.com/pages/landing/student-program) | Illimité |
| HubSpot Academy | Cours de marketing et de vente gratuits avec certification. | [Lien](https://academy.hubspot.com/courses?page=1#certsOnly=true) | Illimité |
| SEMrush | Cours et examens de marketing numérique en ligne gratuits. | [Lien](https://www.semrush.com/academy/) | Illimité |
| Méta | Associé certifié en marketing numérique Méta | [Lien](http://www.facebook.com/business/learn/certification/exams/100-101-exam) | Illimité |
| Microsoft | Professionnel certifié Microsoft Advertising. | [Lien](https://learninglab.about.ads.microsoft.com/training/training-certification/) | Illimité |
...
| Fournisseur | Description | Lien | Expiration |
| --- | --- | --- | --- |
| Salesforce | Cours Salesforce gratuits avec parcours d'apprentissage professionnel et _superbadges_. Également, une demi-journée gratuite [Webinaire de préparation à la certification Salesforce](https://trailhead.salesforce.com/credentials/cert-days), offrant un coupon de réduction de 70 $ pour tout examen de 200 $ pour tous les participants. | [Lien](https://trailhead.salesforce.com/fr/home) | Illimité |
| Revenera | Certification Revenera, gratuite pour les membres agréés de la communauté juridique. | [Lien](https://info.revenera.com/SCA-Legal-Certification-Program-Request) | Illimité |
| Kahoot! | Kahoot! Certifié pour les écoles, ce programme gratuit est conçu pour aider les enseignants à devenir les super-héros ultimes de Kahoot!. | [Lien](https://kahoot.com/blog/2020/09/18/kahoot-certified-for-schools-better-than-before/) | Illimité |
| Expliquez tout | Cours et certification gratuits Expliquez tout. | [Lien](https://explaineverything.com/the-explain-everything-certification-course-is-here/) | Illimité |
| SkillFront | Programme gratuit SkillFront Entrepreneur™ : Fondements de l'entreprise et de l'entrepreneuriat™ | [Lien](https://www.skillfront.com/Free-Business-Entrepreneurship-Program-Certification) | Illimité |
| CertiProf | Travail à distance gratuit et collaboration virtuelle - RWVCPC | [Lien](https://certiprof.com/pages/certificat-de-travail-a-distance-et-de-collaboration-virtuelle-rwvcpc) | Inconnu |
| CertiProf| Certification professionnelle Business Model Canvas Essentials - BMCEPC | [Lien](https://certiprof.com/pages/business-model-canvas-essentials-bmce) | Inconnu |
| CertiProf| Certification professionnelle Business Intelligence Foundation - BIFPC (espagnol uniquement) | [Lien](https://certiprof.com/pages/business-intelligence-foundation-professional-certification-bifpc) | Inconnu |
| Slack | Parcours d'apprentissage et badges Slack Skill gratuits (émis par accredible.com - ce ne sont pas des certifications mais des badges pour les spécialistes des compétences) | [Lien](https://www.slackcertified.com/page/slack-skills) | Inconnu |
| Reuters | Cours de formation Reuters : Introduction au journalisme numérique | [Lien](https://reutersdigitaljournalism.com/) | Inconnu
